...
if (len(sys.argv[1:])==0):
  print "Usage: python jsonschema_val.py rel-path-to-item rel-path-to-schema-file [rel-path-to-root-dir]"
  exit()
elif (len(sys.argv[1:])==1):
  print "Usage: python jsonschema_val.py rel-path-to-item rel-path-to-schema-file"
  exit()
...
resolver = jsonschema.RefResolver('file://' + root_dir_path + '/', None)
